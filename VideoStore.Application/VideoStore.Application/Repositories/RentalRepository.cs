...
public class RentalRepository : IRentalRepository
{
    ...
    public void RentVideo(Rental rental)
    {
        ...
        var sql = @"
            INSERT INTO rentals (id, customer_id, video_id, rented_at, due_date, returned_at, late_fee)
            VALUES (@Id, @CustomerId, @VideoId, @RentedAt, @DueDate, @ReturnedAt, @LateFee)";
    ...
    public List<Rental> GetAllRentals()
    {
        ...
        var sql = "SELECT id, customer_id, video_id, rented_at, due_date, returned_at, late_fee FROM rentals";
    ...
    public Rental GetRental(Guid id)
    {
        ...
        var sql = "SELECT id, customer_id, video_id, rented_at, due_date, returned_at, late_fee FROM rentals WHERE id = @Id";
    ...
    public List<Rental> GetActiveRentalsForCustomer(Guid customerId)
    {
        ...
        var sql = @"
            SELECT id, customer_id, video_id, rented_at, due_date, returned_at, late_fee 
            FROM rentals 
